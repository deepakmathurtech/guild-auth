...
const configs: Record<string, WorkbenchConfig<keyof EntityMap | 'activityLogs'>> = {
  organizations: {
    ...
    roles: ['receptionist', 'guildManager', 'guildAdmin'],
  ...
  admin: {
    ...
    fields: [
      ...
      { name: 'role', label: 'Role', type: 'select', options: ['member', 'contributor', 'receptionist', 'guildManager', 'guildAdmin'] },
      { name: 'city', label: 'City', type: 'text' },
    ...
    defaults: { role: 'member', skills: [], interests: [], verificationStatus: 'pending', guildRank: 'Initiate', reputationScore: 0, completedQuests: 0, verifiedOutcomes: 0, revenueEarned: 0, activityHistory: [] }
  }
};
